          ...
          <div className="grid grid-cols-2 gap-12">
            {[
              { 
                ...
                desc: 'Generate complete articles in minutes, not hours.' 
              },
              { 
              ...
              { 
                ...
                desc: 'Unlike other AI tools, ContentFlow has standards—it reviews and fixes its own mistakes automatically.' 
              }
            ].map((feature) => (
